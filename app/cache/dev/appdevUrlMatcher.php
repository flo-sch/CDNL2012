...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // CDNL2012ProjectsBundle_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'CDNL2012ProjectsBundle_homepage');
            }
            return array (  '_controller' => 'CDNL2012\\ProjectsBundle\\Controller\\LandingController::indexAction',  '_route' => 'CDNL2012ProjectsBundle_homepage',);
        }
